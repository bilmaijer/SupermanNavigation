...
public enum BleManager implements BLEDelegate {
    ...
    public static final int CONNCTION_DELAY_MILLIS = 3000;
    ...
    public void connect(final RxBleDevice bleDevice) {
    ...
    public void reconnect() {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                connect(MovesenseConnectedDevices.getConnectedRxDevice(0));
            }
        }, 2000);
    }
