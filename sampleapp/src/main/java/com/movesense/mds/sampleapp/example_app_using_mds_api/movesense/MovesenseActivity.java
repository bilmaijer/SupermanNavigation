...
public class MovesenseActivity extends AppCompatActivity implements MovesenseContract.View, View.OnClickListener {
    ...
    @BindView(R.id.startScanningBtn)
    TextView mStartScanningBtn;

    private static final int MY_PERMISSIONS_REQUEST_LOCATION = 98;
    @BindView(R.id.stopScanningBtn)
    TextView mStopScanningBtn;
    ...
    public void onClick(View v) {
        ...
        Log.e(TAG, "TEST: Connecting to : " + rxBleDevice.getName() + " " + rxBleDevice.getMacAddress());

        mMovesenseProgressBar.setVisibility(View.GONE);

        mMovesensePresenter.connect(rxBleDevice, this);
